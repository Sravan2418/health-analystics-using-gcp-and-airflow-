...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='bkt-src-global-health-data',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='healthcare-project-452218.staging_dataset.global',  # Replace with your project, dataset, and table name
        source_format='CSV', 
